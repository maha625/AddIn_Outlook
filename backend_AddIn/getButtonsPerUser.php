...
try {
    ...
    $buttonStmt = $conn->prepare("SELECT id, client_id, label, bg_color, text_color, icon,dolibarr_type_code,allow_linked_events FROM client_buttons WHERE client_id = ? ORDER BY id ASC");
